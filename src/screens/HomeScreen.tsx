...
export default function HomeScreen({
  ...
  const handleComponent = (key: number) => {
    if (itemClick.includes(key)) {
      ...
      setItemClick(pre => {
        let arr = [...pre, key];
        setSeeAll(arr.length == listData.length);
        return arr;
      });
    }
  };
  ...
  const handleSeeAll = () => {
    setSeeAll(!seeAll);
    if (!seeAll == true)
      setItemClick(Array.from({length: listData.length}, (_, index) => index));
    else setItemClick([]);
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
          <Header_1
            img={require('../assets/header_1.png')}
            cal='500 Liquid Kcal'
            text='Other Drinks'
          />

          <Pressable style={styles.calenderContainer} onPress={showDatePicker}>
            <Feather name='calendar' size={18} color='black' />
            <Text style={styles.calenderText}>
              {monthYear.date} {monthYear.month} {monthYear.year}
            </Text>
          ...
          <View style={styles.labelsContainer}>
            ...
            <View
              ...
              <Text
                style={{...styles.labelsContainerText, color: colors.secondary}}
                numberOfLines={2}>
          ...
          <View style={styles.dashboardContainer}>
            <View style={styles.dashboardTop}>
              ...
              <TouchableOpacity onPress={handleSeeAll}>
                <Text style={styles.dashboardTopRight}>
                  {' '}
          ...
          <View style={{marginBottom: 10}}>
            ...
            <ButtonComp
              text='Save Changes'
              color={colors.secondary}
              onPress={handleReportNavigation}
            />
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
